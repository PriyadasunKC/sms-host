...
const PlayerReviews = () => {
  ...
  const currentUserData = async (page) => {
    ...
    const playerReviewResponse = await axios.post(`${baseUrl}/api/v1/review/get-overall-review`,{page:page});
...
const handleCoachNameSearch = async(value) => {
  ...
  try {
    const searchResponse = await axios.post(`${baseUrl}/api/v1/review/search-review`,{coachName:value})
