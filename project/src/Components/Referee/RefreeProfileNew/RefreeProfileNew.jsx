    ...
    try {
      if (fileListProfile.length > 0) {
        ...
        const profileImageResponse = await axios.post(
          `${baseUrl}/api/v1/refreeProfile/Refree-profile-image-upload`,
      ...
      if (fileListCover.length > 0) {
        ...
        const coverImageResponse = await axios.post(
          `${baseUrl}/api/v1/refreeProfile/Refree-cover-image-upload`,
          coverImageFormData
        );
      ...
      const playerProfileResponse = await axios.post(
        `${baseUrl}/api/v1/refreeProfile/Refree-profile`,
        {
          RefreeId,
          RefreeName,
          RefreeEmail,
...
export default RefreeProfileNew;
