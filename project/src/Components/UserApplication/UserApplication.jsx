...
const handleStatus = async (id, status) => {
    ...
    try {
     ...
     console.log(location.state.record.UserRole);
      const aproveResponse = await axios.post(`${baseUrl}/api/v1/aprove/aprove-user-model`,{email:location.state.record.Email,userRole:location.state.record.UserRole})
