...
const EOViewFixture = () => {
  ...
  const fetchData = async (page) => {
    try {
      const response = await axios.post(`${baseUrl}/api/v1/get/pagination`, {
        page,
      });
  ...
  const getFixtureData = async () => {
    try {
      const response = await axios.get(`${baseUrl}/api/v1/get/get-fixture`);
    } catch (error) {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const deleteResponse = await axios.post(
        `${baseUrl}/api/v1/delete/delete-fixture`,
        { id }
      );
  ...
  const handleEventLocationSearch = async (value) => {
    ...
    try {
      const searchResponse = await axios.post(`${baseUrl}/api/v1/search/data`, {
        value: value,
                ...
                },
                {
                  ...
                  render: (text, record) => (
                    ...
                    >
                      <Tooltip
                        title={
                          record.createdFixtureId === ""
                            ? "Please shuffle fixture and then view"
                            : "View fixture"
                        }
                      >
                        <Button
                          ...
                          disabled={
                            record.createdFixtureId === "" ? true : false
                          }
                        >
                          View
                        </Button>
