...
const handleReviewSection = async()=>{
    ...
    console.log(battingRating,bowlingRating,fieldingRating,formattedRating,comments);
     ...
     try {
      const response = await axios.post(`${baseUrl}/api/v1/review/create-review`,{battingReview:battingRating,bowlingReview:bowlingRating,fieldingReview:fieldingRating,overallReview:formattedRating,comment:comments,playerId:id,reviewGivenCoachId:reviewGivenCoachId,reviewGivenCoachEmail:reviewGivenCoachEmail,reviewGivenCoachName:reviewGivenCoachName})
