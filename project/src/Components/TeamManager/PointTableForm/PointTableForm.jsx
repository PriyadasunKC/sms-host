...
const PointTableForm = () => {
  ...
  const handleCreate = async () => {
    try {
      await axios.post(
        `${baseUrl}/api/v1/PointTableForm/createPointTableForm`,
        {
          nameOfTheMatch,
          nameOfTheTeam,
          wonMatches,
        ...
        >
          <div className="PointTableForm">
            <div
              ...
              style={{ backgroundColor: "#15295E", padding: "10px" }}
            >
              <h3
                style={{
                  color: "white",
              ...
              <a href="#">
                <CloseSquareOutlined
                  style={{ color: "white", fontSize: "20px", float: "right" }}
                />
              </a>
            </div>
            <div
