...
import "./TeamManagerToEOCommunication.css";
...
const TeamManagerToEOCommunication = () => {
  ...
  const getOnlyEventOrganizers = async () => {
    try {
      const response = await axios.get(`${baseUrl}/api/v1/event-organizer/details`)
                    ...
                    render: (text, record) => (
                      ...
                      >
                        <Button
                          type="primary"
                          onClick={() => {
                            navigate("/team-manager-to-eo-communication-form",{state:{record:record}});
                          }}
                          style={{
...
export default TeamManagerToEOCommunication;
