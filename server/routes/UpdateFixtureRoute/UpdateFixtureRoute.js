...
const { getAllCreatedFixtureController, deleteFixtureController,fixtureUpdateController,getCurrentCreatedFixtureController } = require('../../controllers/UpdateFixtureController/UpdateFixtureController');
